...
function showBtn(nomeItem){
			...
			function sendMyForm(nomeItem){
				nomeItem = "div"+nomeItem
				var theDiv = document.getElementsByName(nomeItem)[0]
				var price = theDiv.getElementsByName("price")
				if(!isNaN(price) && price[0] !== "-" && price[price.length] === String.fromCharCode(8364)){
					theDiv.getElementsByTag("form").submit();
				}
			}			
