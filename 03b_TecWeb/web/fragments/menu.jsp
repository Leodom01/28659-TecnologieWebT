<div id="menu">
	<ul id="tabs">
		<li <%= request.getRequestURI().contains("home") ? "style=\"background-color: #bbb;\"" : ""%>>
			<a href="<%= request.getContextPath() %>/pages/home.jsp">Home</a>
		</li>
		<li <%= request.getRequestURI().contains("catalogue") ? "style=\"background-color: #ccc;\"" : ""%>>
			<a href="<%= request.getContextPath() %>/pages/catalogue.jsp">Manage catalogue</a>
		</li>
		<li <%= request.getRequestURI().contains("cart") ? "style=\"background-color: #dfd;\"" : ""%>>
